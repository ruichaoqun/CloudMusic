...
//        }
    ...
    public void setTransparency() {
        final BroswerAdapter.ViewHolder viewHolder = (BroswerAdapter.ViewHolder) findViewHolderForAdapterPosition(currentPosition);
        if (viewHolder != null && viewHolder.cover != null)
            viewHolder.cover.animate().alpha(0.20f);
    }
